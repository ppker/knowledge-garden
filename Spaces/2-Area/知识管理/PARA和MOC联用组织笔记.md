...
- 通过[[daily note]]建立[[闪念笔记]]
	- 闪念笔记定期手动移动至相关的 PARA 文件夹下面。
	- 或者直接让闪念笔记躺在那不动，变成[[永久笔记]]，期待将来某一天通过搜索能临幸。
- 通过[[∑ MOCs]]的 tag 的 pages 建立文献笔记和项目笔记
...
- 倒是需要考虑，如何用[[Spaces/3-Resource/软件梳理/macos软件/Obsidian]]写那种给别人看的长文，引用卡片还是直接复制,目前看 logseq 的块引用很有用，但现在太卡了，而且块引用的语法也不兼容 ^d67e1d
...
- 按需搜索为主，别去翻它，避免陷进去
- 由于目标是往[[Spaces/3-Resource/软件梳理/macos软件/Obsidian]]放自己的思考和输出，所以量不大，可能这一生都没有归档的必要。看后面实际情况再决定
![[Archive.base]]
